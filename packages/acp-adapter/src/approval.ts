 ...
 *    options surfaced in the TUI by `apps/pythinker-code/src/tui/reverse-rpc/approval/adapter.ts:13`'s
...
/**
 * Translate an ACP {@link RequestPermissionResponse} into Pythinker's
...
export function permissionResponseToApprovalResponse(
  ...
  switch (optionId) {
    ...
    // Legacy Python pythinker-cli (< v0.9.0) used 'approve' as the
    ...
    // Legacy Python pythinker-cli (< v0.9.0) used 'approve_for_session' as
