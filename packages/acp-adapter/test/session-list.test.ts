    ...
    const summaries: SessionSummary[] = [
      {
        ...
        title: 'My first chat',
        workDir: '/repo/a',
        sessionDir: '/home/.pythinker/sessions/sess-a',
      ...
      },
      {
        ...
        title: 'Refactor',
        workDir: '/repo/b',
        sessionDir: '/home/.pythinker/sessions/sess-b',
    ...
    const summaries: SessionSummary[] = [
      {
        id: 'sess-here',
        workDir: '/repo/here',
        sessionDir: '/home/.pythinker/sessions/sess-here',
        createdAt: 0,
        updatedAt: 0,
      },
      {
        ...
        sessionDir: '/home/.pythinker/sessions/sess-elsewhere',
        createdAt: 0,
        updatedAt: 0,
      },
    ];
    ...
    const summaries: SessionSummary[] = [
      {
        id: 'sess-untitled',
        workDir: '/repo/u',
        sessionDir: '/home/.pythinker/sessions/sess-untitled',
        createdAt: 0,
        updatedAt: 1,
      },
      {
        ...
        title: '',
        workDir: '/repo/e',
        sessionDir: '/home/.pythinker/sessions/sess-empty-title',
        createdAt: 0,
        updatedAt: 2,
      },
    ];
