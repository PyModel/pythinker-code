 ...
 *
 * Usage:
 *   PYTHINKER_SERVER_URL=http://127.0.0.1:58627 npx tsx scenarios/10-prompt-queue-steer.ts
 *
 * Exit codes:
 *   0  — pass
...
async function injectActivePrompt(
  ...
  const url = `${PYTHINKER_SERVER_URL}${API_PREFIX}/debug/prompts/${encodeURIComponent(sid)}/active`;
