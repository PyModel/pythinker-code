...
workspace_node_modules=(
  ...
  "pkg_server:/workspace/pythinker-code/packages/server/node_modules"
  "pkg_server-e2e:/workspace/pythinker-code/packages/server-e2e/node_modules"
  ...
  "pkg_migration-legacy:/workspace/pythinker-code/packages/migration-legacy/node_modules"
...
if [[ ! -e /workspace/pythinker-code/node_modules/.modules.yaml || ! -e /workspace/pythinker-code/packages/server-e2e/node_modules/ws ]]; then
...
cd /workspace/pythinker-code/packages/server-e2e
pnpm test:scenarios
EOS
...
docker_args=(
  ...
  --init
  --name "${CONTAINER}"
  --workdir /workspace/pythinker-code/packages/server-e2e
