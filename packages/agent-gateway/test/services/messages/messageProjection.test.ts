...
import type { ContextMessage } from '@pymodel/agent-core-v2';
...
describe('toProtocolMessage', () => {
  ...
  it('projects a daemon-ref image part to a session_media source', () => {
    const msg: ContextMessage = {
      ...
      content: [
        ...
        { type: 'image_url', imageUrl: { url: 'pythinker-file://file_9?path=%2Fcache%2Fpic.png' } },
      ],
      toolCalls: [],
    };
  ...
  it('preserves media names in live and prompt projections', () => {
    const part = {
      ...
      imageUrl: { url: 'pythinker-file://file_9', id: 'file_9', name: 'photo.png' },
    };
  ...
  it('projects a pythinker-file video reference to a structured file source without leaking the path', () => {
    const msg: ContextMessage = {
      role: 'user',
      content: [
        { type: 'video_url', videoUrl: { url: 'pythinker-file://file_9?path=%2Fcache%2Fclip.mp4' } },
      ],
      toolCalls: [],
    };
