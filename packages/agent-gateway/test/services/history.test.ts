...
describe('foldWireHistory interactions, facts and modes', () => {
  ...
  it('folds goal, plan, dynamic_workflow and task records into system and task entities', () => {
    const messages = fold([
      ...
      rec('dynamic_workflow_mode.enter', { trigger: 'user' }, T0 + 8),
      rec('dynamic_workflow_mode.exit', {}, T0 + 9),
      rec(
        'task.started',
        {
          info: {
