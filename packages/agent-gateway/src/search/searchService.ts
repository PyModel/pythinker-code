...
import { normalizeLiteral, tokenize } from '@pymodel/minidb';
import type { TranscriptStore } from '@pymodel/transcript';
 ...
 * thread (default ON). Disable via `PYTHINKER_CODE_EXPERIMENTAL_SEARCH_WORKER=false`
...
registerFlagDefinition({
  ...
  env: 'PYTHINKER_CODE_EXPERIMENTAL_SEARCH_WORKER',
  default: true,
  surface: 'core',
});
