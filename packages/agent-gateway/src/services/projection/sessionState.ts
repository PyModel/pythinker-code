...
export class SessionStateAggregator {
  ...
  feedMainStatus(event: {
    ...
    if (event.dynamicWorkflowMode !== undefined) this.dynamicWorkflowMode = event.dynamicWorkflowMode;
  ...
  private computeModes(): SessionStateModes | undefined {
    ...
    if (this.dynamicWorkflowMode) modes.dynamic_workflow = {};
    return modes.plan === undefined && modes.dynamic_workflow === undefined ? undefined : modes;
  }
}
