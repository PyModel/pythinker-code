import { daemonFileRefFromPart, parseDaemonFileUrl, type ContentPart, type ContextMessage } from '@pymodel/agent-core-v2';
 ...
 * the internal `pythinker-file://` URL becomes the stored read-model contract.
 */
