/**
 * Pythinker host and device identity header factories.
 *
...
export interface PythinkerIdentityOptions extends PythinkerHostIdentity {
  readonly homeDir: string;
}

export interface CreatePythinkerDeviceIdOptions {
...
export function readPythinkerDeviceId(homeDir: string): string | null {
...
export function createPythinkerDeviceId(
  homeDir: string,
  options: CreatePythinkerDeviceIdOptions = {},
): string {
  const existing = readPythinkerDeviceId(homeDir);
