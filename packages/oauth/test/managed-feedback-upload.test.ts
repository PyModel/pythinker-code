...
describe('pythinkerCodeFeedbackUploadUrl', () => {
  it('uses the feedback upload_url path', () => {
    expect(pythinkerCodeFeedbackUploadUrl()).toBe('https://api.kimi.com/coding/v1/feedback/upload_url');
  });
});

describe('pythinkerCodeFeedbackUploadCompleteUrl', () => {
  it('uses the feedback upload_complete path', () => {
    expect(pythinkerCodeFeedbackUploadCompleteUrl()).toBe(
