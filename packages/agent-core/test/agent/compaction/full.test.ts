...
describe('FullCompaction', () => {
  ...
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    const onAfterCompaction = vi.fn(async () => {});
    const ctx = testAgent({
    ...
    expect(onAfterCompaction).toHaveBeenCalledOnce();
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "pythinker-code", "usage": { "inputOther": 520, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 120, "maxContextTokens": 256000, "contextUsage": 0.00046875, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 520, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 520, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] context.apply_compaction   { "summary": "Compacted summary.", "compactedCount": 6, "tokensBefore": 39, "tokensAfter": 5, "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 520, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 520, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('compacts only messages before a selected user prompt', async () => {
    const ctx = testAgent();
    ctx.configure({
      provider: CATALOGUED_PROVIDER,
      modelCapabilities: CATALOGUED_MODEL_CAPABILITIES,
    ...
    ctx.appendExchange(3, 'user three', 'assistant three', 60);
    const compacted = ctx.once('context.apply_compaction');

    ctx.mockNextResponse({ type: 'text', text: 'Summary before prompt two.' });
    await ctx.rpc.beginCompaction({ promptFromEnd: 2, direction: 'up_to' } as never);
    await compacted;
    ...
    expect(ctx.compactHistory()).toEqual([
      { role: 'assistant', text: 'Summary before prompt two.' },
      { role: 'user', text: 'user two' },
      { role: 'assistant', text: 'assistant two' },
      { role: 'user', text: 'user three' },
      { role: 'assistant', text: 'assistant three' },
    ]);
    await ctx.expectResumeMatches();
  });

  it('compacts from a selected user prompt through the active tail', async () => {
    const ctx = testAgent();
    ctx.configure({
      provider: CATALOGUED_PROVIDER,
      modelCapabilities: CATALOGUED_MODEL_CAPABILITIES,
    ...
    ctx.mockNextResponse({ type: 'text', text: 'Summary from prompt two.' });
    ...
    expect(ctx.lastLlmInput()).toMatchInlineSnapshot(`
      ...
      messages:
        ...
        user: text "user three"
        assistant: text "assistant three"
        user: text <compaction-instruction>
    `);
    expect(ctx.compactHistory()).toEqual([
      { role: 'user', text: 'user one' },
      { role: 'assistant', text: 'assistant one' },
      { role: 'assistant', text: 'Summary from prompt two.' },
    ]);
    await ctx.expectResumeMatches();
  });
  ...
  it('fires PreCompact and PostCompact hooks from the compaction module', async () => {
    ...
    const ctx = testAgent({
      hookEngine: new HookEngine(
        [
          ...
          { event: 'SessionStart', matcher: 'compact', command: hookCommand, timeout: 5 },
    ...
    const [pre, sessionStart, post] = readHookPayloads(hookLog);
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "pythinker-code", "usage": { "inputOther": 499, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 80, "maxContextTokens": 256000, "contextUsage": 0.0003125, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 499, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 499, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] context.apply_compaction   { "summary": "Compacted prefix.", "compactedCount": 4, "tokensBefore": 25, "tokensAfter": 5, "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 499, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 499, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete   { "time": "<time>" }
  ...
  it('cancels when the compacted prefix changes before completion', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record             { "model": "pythinker-code", "usage": { "inputOther": 499, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated     { "model": "pythinker-code", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 499, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 499, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record                { "model": "pythinker-code", "usage": { "inputOther": 498, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 950000, "maxContextTokens": 256000, "contextUsage": 3.7109375, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 498, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 498, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] context.apply_compaction    { "summary": "Auto compacted summary.", "compactedCount": 4, "tokensBefore": 46, "tokensAfter": 28, "time": "<time>" }
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 28, "maxContextTokens": 256000, "contextUsage": 0.000109375, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 498, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 498, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [wire] usage.record                { "model": "pythinker-code", "usage": { "inputOther": 31, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 42, "maxContextTokens": 256000, "contextUsage": 0.0001640625, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 529, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 529, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 31, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('emits context.overflow and terminates the turn after too many auto compactions', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 6, "maxContextTokens": 1000000, "contextUsage": 0.000006, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 482, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 482, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
