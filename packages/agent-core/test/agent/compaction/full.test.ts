...
describe('FullCompaction', () => {
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] llm.request                { "kind": "compaction", "provider": "pythinker", "model": "pythinker-code", "modelAlias": "pythinker-code", "thinkingEffort": "off", "maxTokens": 131072, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 7, "droppedCount": 0, "time": "<time>" }
      [wire] usage.record               { "model": "pythinker-code", "usage": { "inputOther": 1181, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 120, "maxContextTokens": 256000, "contextUsage": 0.00046875, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1181, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1181, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 158, "maxContextTokens": 256000, "contextUsage": 0.0006171875, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1181, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1181, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "pythinker-code", "usage": { "inputOther": 1152, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 80, "maxContextTokens": 256000, "contextUsage": 0.0003125, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1152, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1152, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "pythinker-code", "contextTokens": 160, "maxContextTokens": 256000, "contextUsage": 0.000625, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1152, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1152, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete   { "time": "<time>" }
  ...
  it('cancels when the compacted prefix changes before completion', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated     { "model": "pythinker-code", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual" }
      [wire] llm.tools_snapshot       { "hash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "tools": [], "time": "<time>" }
      [wire] llm.request              { "kind": "compaction", "provider": "pythinker", "model": "pythinker-code", "modelAlias": "pythinker-code", "thinkingEffort": "off", "maxTokens": 131072, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "messageCount": 5, "droppedCount": 0, "time": "<time>" }
      [wire] usage.record             { "model": "pythinker-code", "usage": { "inputOther": 1152, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated     { "model": "pythinker-code", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1152, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1152, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record                { "model": "pythinker-code", "usage": { "inputOther": 1173, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 950000, "maxContextTokens": 256000, "contextUsage": 3.7109375, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1173, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1173, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 166, "maxContextTokens": 256000, "contextUsage": 0.0006484375, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1173, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1173, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [wire] usage.record                { "model": "pythinker-code", "usage": { "inputOther": 165, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
      [emit] agent.status.updated        { "model": "pythinker-code", "contextTokens": 176, "maxContextTokens": 256000, "contextUsage": 0.0006875, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "pythinker-code": { "inputOther": 1338, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1338, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 165, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('preserves thinking effort when compacting after provider context overflow', async () => {
    ...
    expect(callCount).toBe(3);
    // A Pythinker model without supportEfforts is boolean-only, so the effective
  ...
  it('honors completion budget env opt-out during compaction', async () => {
    vi.stubEnv('PYTHINKER_MODEL_MAX_COMPLETION_TOKENS', '0');
    let callCount = 0;
    const compactionMaxCompletionTokens: unknown[] = [];
    const generate: GenerateFn = async (provider, _system, _tools, _history, callbacks) => {
      callCount += 1;
  ...
  it('honors maxOutputSize from model config during compaction', async () => {
    ...
    // Set maxOutputSize on the harness's internal pythinkerConfig — the
    // compaction path reads it via ConfigState.maxOutputSize.
    const models = (ctx as unknown as { pythinkerConfig: PythinkerConfig }).pythinkerConfig.models;
  ...
  it('emits context.overflow and terminates the turn after too many auto compactions', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 153, "maxContextTokens": 1000000, "contextUsage": 0.000153, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 1135, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1135, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 165, "maxContextTokens": 1000000, "contextUsage": 0.000165, "planMode": false, "dynamicWorkflowMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 1289, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1289, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 154, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [emit] turn.step.interrupted       { "turnId": 0, "step": 2, "reason": "error", "message": "Compaction limit exceeded (1)" }
      [emit] turn.ended                  { "turnId": 0, "reason": "failed", "error": { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "PythinkerError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true } }
    `);
    expect(ctx.newEvents()).toMatchInlineSnapshot(
      `[emit] error   { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "PythinkerError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true }`,
    );
    expect(ctx.llmInputs()).toMatchInlineSnapshot(`
      call 1:
        system: <system-prompt>
  ...
  it('serializes a goal continuation when background auto compaction starts after a step', async () => {
    ...
    const generate: GenerateFn = async (_provider, _system, _tools, history) => {
      ...
      if (llmCallCount === 3) return textResult('Continued after compaction.');
      throw new Error(`Unexpected generate call ${String(llmCallCount)}`);
    };
    ...
    await ctx.agent.goal.setBudgetLimits({ budgetLimits: { turnBudget: 2 } });
    ctx.appendExchange(1, 'old user one', 'old assistant one', 20);
    ctx.newEvents();
    ...
    const goalWhileCompacting = ctx.agent.goal.getGoal().goal;
    ...
    expect(goalWhileCompacting).toMatchObject({
      status: 'paused',
      terminalReason:
  ...
  it('keeps the goal paused when background auto compaction fails', async () => {
    const compactionRequested = deferred<void>();
    const releaseCompaction = deferred<void>();
    let llmCallCount = 0;
    const generate: GenerateFn = async () => {
  ...
  it('preserves a user pause when background auto compaction later succeeds', async () => {
    const compactionRequested = deferred<void>();
    const releaseCompaction = deferred<void>();
    let llmCallCount = 0;
    const generate: GenerateFn = async () => {
    ...
    const turnDone = ctx.agent.turn.waitForCurrentTurn();
    await compactionRequested.promise;
    await ctx.agent.goal.pauseGoal({ reason: 'Paused by user' });
    releaseCompaction.resolve();
    const outcome = await compactionOutcome;
    await turnDone;
  ...
  it('defers an explicit resume until background auto compaction succeeds', async () => {
    const compactionRequested = deferred<void>();
    const releaseCompaction = deferred<void>();
    let llmCallCount = 0;
    const generate: GenerateFn = async () => {
    ...
    const turnDone = ctx.agent.turn.waitForCurrentTurn();
    await compactionRequested.promise;
    const resumeResult = await ctx.agent.goal.resumeGoal();
...
function getMicroCompactionFlagEnv(): string {
  ...
  return 'PYTHINKER_CODE_EXPERIMENTAL_MICRO_COMPACTION';
}
...
function compactAfterFirstStep(): CompactionStrategy {
  let checks = 0;
  return {
    shouldCompact: () => {
      checks += 1;
