...
describe('AgentBackgroundTask — timeoutMs', () => {
  ...
  // pythinker-code do NOT carry an implicit default timeout. The Python
  // pythinker-cli enforced a 30-min default because its agents were
  // expected to be short-lived; pythinker-code's agents may legitimately
  ...
  // Contract decision (2026-05-21): pythinker-code treats `timeoutMs: 0`
