import type { PythinkerConfig } from './schema';

/**
 * Print-mode (`pythinker -p`) defaults for the v1 engine. A headless run should not
 ...
 */
export function applyPrintModeConfigDefaults(config: PythinkerConfig): PythinkerConfig {
  return {
    ...config,
