...
export const MASTER_ENV = 'PYTHINKER_CODE_EXPERIMENTAL_FLAG';
 ...
 *   L1 master switch PYTHINKER_CODE_EXPERIMENTAL_FLAG → every flag is on
 ...
 * Runtime code that belongs to a PythinkerCore/Session/Agent should use the scoped
