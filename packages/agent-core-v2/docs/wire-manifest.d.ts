...
//   dynamic_workflow_mode.enter                   dynamic_workflow                 persisted  src/agent/dynamic_workflow/dynamic_workflowOps.ts
//   dynamic_workflow_mode.exit                    dynamic_workflow                 persisted  src/agent/dynamic_workflow/dynamic_workflowOps.ts
...
/**
 * model: dynamic_workflow · persisted · toEvent
 * owner: src/agent/dynamic_workflow/dynamic_workflowOps.ts
 */
...
/**
 * model: dynamic_workflow · persisted · toEvent · cross-reducers: contextMemory
 * owner: src/agent/dynamic_workflow/dynamic_workflowOps.ts
 */
