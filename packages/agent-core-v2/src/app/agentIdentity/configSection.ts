 ...
 * Both bind to `PYTHINKER_CODE_IDENTITY_NAME` / `PYTHINKER_CODE_IDENTITY_SLUG` so a
...
export const IDENTITY_NAME_ENV = 'PYTHINKER_CODE_IDENTITY_NAME';
export const IDENTITY_SLUG_ENV = 'PYTHINKER_CODE_IDENTITY_SLUG';
