/**
 * `pythinker-cu` capability entry (macOS only).
 *
 * Layers: the official `pythinker-cu` plugin (stdio MCP wrapper + skill) +
 * PythinkerCU.app (`/Applications`, launchd background service) + TCC
...
const PLUGIN_ID = 'pythinker-cu';
const PLUGIN_ZIP_URL = 'https://cdn.kimi.com/pythinker-computer-use/latest/pythinker-cu-plugin.zip';
