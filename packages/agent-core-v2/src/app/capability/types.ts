/**
 * `capability` domain types — built-in product capabilities (pythinker-cu,
 * pythinker-webbridge) that bundle a binary runtime + agent wiring + manual
...
export type CapabilityId = 'pythinker-cu' | 'pythinker-webbridge';
