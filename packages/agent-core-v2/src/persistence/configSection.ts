...
export const PERSISTENCE_MINIDB_READMODEL_ENV = 'PYTHINKER_CODE_PERSISTENCE_MINIDB_READMODEL';
export const SEARCH_WORKER_ENV = 'PYTHINKER_CODE_SEARCH_WORKER';
export const SEARCH_SYNC_SESSION_CAP_ENV = 'PYTHINKER_CODE_SEARCH_SYNC_SESSION_CAP';
export const SEARCH_SYNC_DEBOUNCE_MS_ENV = 'PYTHINKER_CODE_SEARCH_SYNC_DEBOUNCE_MS';
