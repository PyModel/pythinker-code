 ...
 * pythinker home, project-root `.mcp.json` — the root discovered through the
 * `git` domain's work-tree probe — and `.pythinker-code/mcp.json` under the cwd)
...
import { resolvePythinkerHome } from '#/app/bootstrap/bootstrap';
