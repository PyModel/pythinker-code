...
export const SECONDARY_MODEL_FLAG_ENV = 'PYTHINKER_CODE_EXPERIMENTAL_SECONDARY_MODEL';
...
export const SUBAGENT_FORK_FLAG_ENV = 'PYTHINKER_CODE_EXPERIMENTAL_SUBAGENT_FORK';

export const subagentForkFlag: FlagDefinitionInput = {
  id: SUBAGENT_FORK_FLAG_ID,
  title: 'Fork context for subagents',
  description:
    'Let the Agent and AgentDynamicWorkflow tools start a subagent with a snapshot of the calling agent\'s conversation history via the fork parameter.',
