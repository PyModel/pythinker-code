...
export const SUBAGENT_SCOPE_CACHE_SIZE_ENV = 'PYTHINKER_CODE_SUBAGENT_SCOPE_CACHE_SIZE';

export const SUBAGENT_SCOPE_EVICT_TIMEOUT_ENV = 'PYTHINKER_CODE_SUBAGENT_SCOPE_EVICT_TIMEOUT_MS';
