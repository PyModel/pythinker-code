...
import { Error2, ErrorCodes, toPythinkerErrorPayload, type PythinkerErrorPayload } from '#/errors';
...
function maxStepsErrorFromPayload(payload: PythinkerErrorPayload): Error2 {
