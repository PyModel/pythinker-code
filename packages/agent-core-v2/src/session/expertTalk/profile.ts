...
const EXPERT_TALK_TOOLS = ['Read', 'Glob', 'Grep', 'ReadMediaFile'] as const;

const EXPERT_TALK_SYSTEM_PROMPT = [
  'You are one participant in Pythinker Discussion.',
...
registerAgentProfile({
  ...
  description: 'Run-scoped read-only participant for Discussion.',
