/**
 * `sessionDynamicWorkflow` domain — batch scheduler for dynamic_workflow agent runs.
 *
 * Defines `ISessionDynamicWorkflowService`, the Session-scoped service that runs a batch
