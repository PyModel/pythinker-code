/**
 * `sessionDynamicWorkflow` domain — `ISessionDynamicWorkflowService` implementation.
 *
 ...
 * carrying the dynamic_workflow's tool-call context, `subagent.suspended` when a task is
...
registerScopedService(
  ...
  ISessionDynamicWorkflowService,
  SessionDynamicWorkflowService,
  ScopeActivation.OnScopeCreated,
  'sessionDynamicWorkflow',
);
