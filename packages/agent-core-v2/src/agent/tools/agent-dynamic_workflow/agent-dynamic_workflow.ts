/**
 * `tools` domain — `IAgentDynamicWorkflowTool` contract (the `AgentDynamicWorkflow` tool).
 *
 * Public contract of the `AgentDynamicWorkflow` collaboration tool: the input zod
 ...
 * subagent count), and the `IAgentDynamicWorkflowTool` DI decorator that the
