 ...
 * operational env override (`PYTHINKER_IMAGE_MAX_EDGE_PX` /
 * `PYTHINKER_IMAGE_READ_BYTE_BUDGET`); `config` resolves each field as
...
export const IMAGE_MAX_EDGE_ENV = 'PYTHINKER_IMAGE_MAX_EDGE_PX';
export const IMAGE_READ_BYTE_BUDGET_ENV = 'PYTHINKER_IMAGE_READ_BYTE_BUDGET';
