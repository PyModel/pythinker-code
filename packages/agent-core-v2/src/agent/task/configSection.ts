 ...
 * accept the v1 env overrides `PYTHINKER_CODE_BACKGROUND_KEEP_ALIVE_ON_EXIT` /
 * `PYTHINKER_CODE_BACKGROUND_MAX_RUNNING_TASKS`
 ...
 * `pythinker -p` print-mode background policy (`printBackgroundMode` /
