...
import type { DynamicWorkflowModeTrigger } from '#/agent/dynamic_workflow/dynamic_workflow';
...
export type SetPythinkerConfigPayload = ResolvedConfig;
...
export interface CoreAPI extends SessionAPIWithId {
  ...
  getPythinkerConfig: (payload: GetPythinkerConfigPayload) => ResolvedConfig;
  getConfigDiagnostics: (payload: EmptyPayload) => ConfigDiagnostics;
  setPythinkerConfig: (payload: SetPythinkerConfigPayload) => ResolvedConfig;
  removePythinkerProvider: (payload: RemovePythinkerProviderPayload) => ResolvedConfig;
