 ...
 * also accept operational env overrides (`PYTHINKER_LOOP_MAX_STEPS_PER_TURN` /
 * `PYTHINKER_LOOP_MAX_ATTEMPTS_PER_STEP`; the former
 * `PYTHINKER_LOOP_MAX_RETRIES_PER_STEP` still resolves as a deprecated fallback
