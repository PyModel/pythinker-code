...
describe('registry-driven vendor verdicts', () => {
  it('drivesThinkingThroughTraits: trait-driven vendors only, no string branches', () => {
    expect(drivesThinkingThroughTraits('pythinker')).toBe(true);
  ...
  it('usesTraitDrivenThinking: native traits and the (pythinker, anthropic) pair registration', () => {
    expect(usesTraitDrivenThinking(registry, 'openai', 'pythinker')).toBe(true);
    expect(usesTraitDrivenThinking(registry, 'anthropic', 'pythinker')).toBe(true);
...
describe('resolveThinkingEffortForModel', () => {
  ...
  it('normalizes unknown efforts back to the model default under pythinker semantics', () => {
  ...
  it('keeps always-thinking models on under pythinker semantics', () => {
    const always = {
  ...
  it('returns a declared default only when the thinking model lists it', () => {
