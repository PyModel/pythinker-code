...
describe('EventDispatcherService', () => {
  it('persists subagent lifecycle facts and replays them without publishing or rerunning work', async () => {
    ...
    const events = [
      new SubagentSpawned({ subagentId: 'child', subagentName: 'explore', parentAgentId: 'main', callerAgentId: 'main', parentToolCallId: 'dynamic-workflow-a', dynamicWorkflowIndex: 2, runInBackground: false }, 1000),
