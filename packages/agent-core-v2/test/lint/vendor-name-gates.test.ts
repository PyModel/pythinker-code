 ...
 * `'pythinker'`. Vendor identity is answered structurally by the kosong
 ...
 * Brand/env names (`PYTHINKER_CODE_*`, `PYTHINKER_MODEL_*`) and `'pythinker'` as data
...
/**
 * Branching on the vendor id: `=== 'pythinker'` / `== 'pythinker'` / `!== 'pythinker'` /
 * `!= 'pythinker'` (either operand order) and `case 'pythinker':`.
 */
