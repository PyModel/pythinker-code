...
export const modesMetaSchema = z.object({
  ...
  dynamic_workflow: z.object({ trigger: z.string().optional() }).optional(),
...
export const modesMetaMergeSchema = z.object({
  plan: z
    ...
    .nullable()
    .optional(),
  dynamic_workflow: z.object({ trigger: z.string().optional() }).nullable().optional(),
 ...
 * (transcript types never live in `@pymodel/protocol`); the v1 connection
