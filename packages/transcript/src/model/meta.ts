...
/** Mode badges (plan mode, dynamic_workflow mode) mirrored at session level. */
export interface ModesMeta {
  readonly plan?: { readonly reviewPath?: string; readonly version?: number };
  readonly dynamic_workflow?: { readonly trigger?: string };
}
...
export interface ModesMetaMerge {
  ...
  readonly dynamic_workflow?: { readonly trigger?: string } | null;
}
