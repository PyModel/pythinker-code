...
const URLS = [
  ...
  'pythinker-file://f_1',
  'pythinker-file://f_1?path=',
  'pythinker-file://?path=%2Fcache%2Fshot.png',
  'pythinker-file://f_1?path=%2Fcache%2Fa%20%26%20%22b%22%20%3Cc%3E.png',
  'pythinker-file://f_1?path=%zz',
  'pythinker-file://',
...
const PARTS: ReadonlyArray<MediaRefPart> = [
  { type: 'image_url', imageUrl: { url: 'pythinker-file://f_1?path=%2Fcache%2Fshot.png' } },
  { type: 'video_url', videoUrl: { url: 'pythinker-file://f_3?path=%2Fcache%2Fclip.mp4' } },
  { type: 'image_url', imageUrl: { url: 'pythinker-file://f_1' } },
