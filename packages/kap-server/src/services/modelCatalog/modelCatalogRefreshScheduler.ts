 ...
 * `PYTHINKER_CODE_MODEL_CATALOG_REFRESH_INTERVAL_MS` /
 * `PYTHINKER_CODE_MODEL_CATALOG_REFRESH_ON_START` env vars as overrides (matching
...
const INTERVAL_ENV = 'PYTHINKER_CODE_MODEL_CATALOG_REFRESH_INTERVAL_MS';
const REFRESH_ON_START_ENV = 'PYTHINKER_CODE_MODEL_CATALOG_REFRESH_ON_START';
