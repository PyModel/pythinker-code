...
import type { Runtime, RuntimeLease } from '@pymodel/agent-core-v2/runtime/runtime';
import { RuntimeWorkspaceView } from '@pymodel/agent-core-v2/runtime/runtimeWorkspaceView';
import type { IHostFsWatchHandle, HostFsChange } from '@pymodel/agent-core-v2/os/interface/hostFsWatch';
import type { FsChangeEntry, FsChangeEvent } from '@pymodel/agent-core-v2/workspace/workspaceFs/fsWatch';
  ...
  private async createSessionWatch(
    ...
    try {
      ...
      const sw: SessionWatch = {
        ...
        debounceMs: readPositiveIntEnv('PYTHINKER_CODE_FS_WATCH_DEBOUNCE_MS', DEFAULT_DEBOUNCE_MS),
        maxChangesPerWindow: readPositiveIntEnv('PYTHINKER_CODE_FS_WATCH_MAX_CHANGES_PER_WINDOW', DEFAULT_MAX_CHANGES_PER_WINDOW),
      };
