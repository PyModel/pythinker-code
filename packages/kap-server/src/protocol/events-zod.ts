...
import type { HookResultEvent } from '@pymodel/agent-core-v2/agent/externalHooks/externalHooksService';
import type {
...
import type { CompactionResult } from '@pymodel/agent-core-v2/agent/fullCompaction/types';
import type {
  GoalActor,
  GoalBudgetLimits,
  GoalBudgetReport,
  ...
  GoalStatus,
  GoalToolResult,
} from '@pymodel/agent-core-v2/agent/goal/types';
import type {
  AssistantDeltaEvent,
  ThinkingDeltaEvent,
  ToolCallDeltaEvent,
...
} from '@pymodel/agent-core-v2/agent/mcp/mcpService';
import type { McpOAuthAuthorizationUrlUpdateData } from '@pymodel/agent-core-v2/agent/mcp/tools/auth';
import type { PermissionMode } from '@pymodel/agent-core-v2/agent/permissionPolicy/types';
import type { WarningEvent } from '@pymodel/agent-core-v2/agent/profile/profileService';
import type { PluginCommandActivatedEvent } from '@pymodel/agent-core-v2/agent/rpc/rpcService';
import type {
  ShellCompletedEvent,
  ShellOutputEvent,
  ShellStartedEvent,
...
import type { TurnStepRetryingEvent } from '@pymodel/agent-core-v2/agent/stepRetry/stepRetryService';
...
import type { SubagentSuspendedEvent } from '@pymodel/agent-core-v2/session/dynamic_workflow/sessionDynamicWorkflowService';
import type { ToolUpdate } from '@pymodel/agent-core-v2/tool/toolContract';
...
export const pythinkerErrorPayloadSchema: z.ZodType<unknown> = z.lazy(
  () => pythinkerErrorPayloadObjectSchema,
);

const pythinkerErrorPayloadObjectSchema = z.object({
  code: pythinkerErrorCodeSchema,
  message: z.string(),
  name: z.string().optional(),
  details: z.record(z.string(), z.unknown()).optional(),
  retryable: z.boolean(),
  cause: pythinkerErrorPayloadSchema.optional(),
});
...
export const errorEventSchema = pythinkerErrorPayloadObjectSchema.extend({
...
export const turnEndedEventSchema = z.object({
  ...
  turnId: z.number(),
  reason: turnEndReasonSchema,
  error: pythinkerErrorPayloadSchema.optional(),
  durationMs: z.number().optional(),
  interruptReason: z
