...
import { MAIN_AGENT_ID } from '@pymodel/agent-core-v2/session/agentLifecycle/agentLifecycle';
...
import { interactions } from '@pymodel/agent-core-v2/human/interaction/facade';
import { IAgentLoopService } from '@pymodel/agent-core-v2/agent/loop/loop';
import type { SkillActivationOrigin } from '@pymodel/agent-core-v2/agent/contextMemory/types';
import { ITelemetryService } from '@pymodel/agent-core-v2/app/telemetry/telemetry';
import type {
  PromptWithSkillsInput,
  SkillActivationInput,
} from '@pymodel/agent-core-v2/features/skill/skill';
import { IAgentSkillService } from '@pymodel/agent-core-v2/features/skill/skillService';
...
/** agent-gateway wire codes mirrored so memory/ipc surface the same numeric codes as `/api/v2/mcp`. */
 ...
 * `RPCError`s carrying the agent-gateway wire codes, so memory and ipc behave
