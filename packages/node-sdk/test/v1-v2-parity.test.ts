...
const CONFIG_ENV_PATTERN =
  /^(PYTHINKER_MODEL_|PYTHINKER_LOOP_|PYTHINKER_MCP_|PYTHINKER_WEB_|PYTHINKER_SECONDARY_|PYTHINKER_IMAGE_|PYTHINKER_CODE_BACKGROUND_|PYTHINKER_CODE_MODEL_CATALOG_)/;
...
// persisted state, btw/dynamic_workflow are context-only, and the `dynamic_workflow()` case uses the
