...
import { createPythinkerHarness, ImageLimits, PythinkerHarness, SDKRpcClientBase } from '#/index';
...
/**
 * The recursive RPC surface PythinkerHarness touches for the tests below: kept
...
`,
  ...
  it('a hand-built harness returns the injected ImageLimits as-is', () => {
    ...
    const harness = new PythinkerHarness(new StubRpc(), {
      homeDir: '/tmp/home',
