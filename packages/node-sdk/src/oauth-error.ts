import { ErrorCodes, PythinkerError } from '@pythoughts/agent-core';
import {
...
/**
 * Classify an OAuth token-fetch failure into the public {@link PythinkerError}
 ...
 * remediation path.
 */
export function mapOAuthTokenError(error: unknown, providerName: string): PythinkerError | undefined {
