...
export abstract class SDKRpcClientBase {
  ...
  abstract getConfig(input?: GetConfigOptions): Promise<PythinkerConfig>;
  ...
  abstract setConfig(input: PythinkerConfigPatch): Promise<PythinkerConfig>;

  abstract removeProvider(providerId: string): Promise<PythinkerConfig>;
  ...
  abstract setDynamicWorkflowMode(input: SetSessionDynamicWorkflowModeRpcInput): Promise<void>;

  abstract dynamic_workflow(input: SessionPromptRpcInput): Promise<void>;
