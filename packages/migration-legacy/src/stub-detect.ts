...
// Verbatim from packages/pythinker-core/src/harness/configs/toml.ts:42
...
// Verbatim from apps/pythinker-code/src/tui/config.ts:renderTuiConfig(DEFAULT_TUI_CONFIG)
