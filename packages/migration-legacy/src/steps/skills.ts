...
/**
 * Copy the user's legacy skills tree (~/.pythinker/skills/) into pythinker-code's
 * default user skills root (~/.pythinker-code/skills/). Granularity is one
...
export async function migrateSkillsStep(input: SkillsStepInput): Promise<SkillsStepResult> {
  ...
  for (const name of entries) {
    ...
    // in it — touching it earlier would fail when ~/.pythinker-code/skills is
