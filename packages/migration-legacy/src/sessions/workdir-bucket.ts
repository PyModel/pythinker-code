 ...
 * `packages/pythinker-core/src/utils/workdir-slug.ts` and
 * `packages/pythinker-core/src/harness/session-manager/workdir-key.ts:13–18`.
 *
...
/**
 * Local copy of pythinker-core's `slugifyWorkDirName`. Keep byte-identical to the
 * canonical implementation in `packages/pythinker-core/src/utils/workdir-slug.ts`.
 */
