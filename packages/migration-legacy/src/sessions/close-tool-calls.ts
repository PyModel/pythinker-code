...
const PLACEHOLDER_TEXT = '[tool result unavailable — session imported from pythinker-cli]';

/**
 * Close dangling tool calls so no messages are dropped on resume.
 *
 * pythinker-core's context module defers messages while a tool exchange is open
 ...
 * id is satisfied. A pythinker-cli session interrupted mid-tool-call therefore
