...
//
// Schema + query layer for the pythinker-code session store, built on minidb.
//
...
export class SessionStore {
  ...
  async ingestPythinkerCode(homeDir: string): Promise<{ workspaces: number; sessions: number; textBytes: number }> {
