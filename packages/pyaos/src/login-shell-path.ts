 ...
 * user's login shell.
 *
 * When pythinker-code is launched from a context that skipped the user's shell
 ...
 * did not already have would widen their search path — LocalPyaos runs
 ...
 * `LocalPyaos.create()` calls must not re-spawn the shell.
 */
/**
