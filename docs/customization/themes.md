...
| `effortLow` | `#E8A838` | `#8A5A00` | Low thinking effort; colors the editor effort dot. |
| `effortMedium` | `#F08C46` | `#9A4A00` | Medium thinking effort; colors the editor effort dot. |
| `effortHigh` | `#EF6666` | `#B42318` | High thinking effort; colors the editor effort dot. |
| `effortXHigh` | `#FF7A7A` | `#991B1B` | Extra-high thinking effort; colors the editor effort dot. |
| `effortMax` | `#FFF0E8` | `#7F1D1D` | Maximum thinking effort; colors the editor effort dot. |
