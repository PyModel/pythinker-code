...
// `pythinker.plugin.json` is authoritative once it exists, and `.pythinker-plugin/plugin.json`
...
export async function readPluginManifestVersion(pluginDir) {
  for (const rel of ['pythinker.plugin.json', '.pythinker-plugin/plugin.json']) {
