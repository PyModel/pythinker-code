...
// memory that `pythinker` never needs; 16 MB keeps scavenges cheap for the CLI's
...
// PYTHINKER_CODE_BUILD_TARGET that differs from the build host) must leave it out.
