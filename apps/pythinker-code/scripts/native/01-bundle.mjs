...
const buildVisAssetPath = resolve(import.meta.dirname, '..', 'build-dashboard-asset.mjs');

export async function runBundleStep() {
  // Generate the embedded `pythinker dashboard` web asset before bundling. The native
