...
export async function collectWebAssets({ appRoot, target }) {
  ...
  return collectAssetRoot({
    ...
    missingMessage: `Pythinker web build output was not found at ${resolve(appRoot, WEB_ASSETS_DIR)}. Run \`${buildCommand}\` before building native SEA assets. App root: ${appRoot}`,
