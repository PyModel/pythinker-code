...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add persistent named agent teams with background teammate spawning, shared task scopes, direct and broadcast messaging, assignment delivery, shutdown coordination, and native terminal identities.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add project, user, and namespaced plugin subagent profiles with per-profile turn limits and persistent memory, context-fork workers, per-agent model and working-directory overrides, and Git worktree isolation with native terminal status.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Preserve full truncated Bash output on disk, interpret informational exit codes, and expand destructive-command warnings in the terminal approval flow.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add clearer TUI startup status, effort heat, Dynamic Workflow progress colors, and a brighter dark-theme primary.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add an agent-callable Config tool for approved, validated reads and writes of supported Pythinker settings.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add configurable Global and Chat TUI keybindings with unbinding, two-key chords, reserved shortcuts, dynamic help labels, template creation, and editor-backed reload.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Show Dynamic Workflow in a coral-framed mission-control panel with live per-agent progress, and let workflow agents run without an automatic timeout.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add fail-closed Read/Edit/Write state tracking, quote-preserving edits, automatic parent creation, and cell-aware Jupyter notebook editing with terminal summaries.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add unchanged-range deduplication and structured Jupyter notebook reads with cell, text-output, and image-output support.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add configurable context-aware keybindings across dialogs, plugins, rewind,
  message actions, footer controls, and both terminal renderers.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add experimental plugin-configured language-server support with lazy stdio servers and agent-callable navigation, symbol, hover, reference, implementation, and call-hierarchy operations.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add MCP resource discovery and reading with terminal-native summaries.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add responsive option previews, per-question notes, answer annotations, automatic Other choices, and source telemetry tags to structured questions.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Complete Glob and Grep parity with absolute glob patterns, sensitive-name filtering, context aliases, and multiple glob filters.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add explicitly requested session worktree entry and exit with named resume, cwd and hook rebinding, safe keep behavior, and fail-closed removal confirmation.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add JSON Schema validated structured output to prompt mode.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add persistent project-task creation, lookup, dependency-aware listing, and updates while retaining explicit background-task listing.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add per-model thinking effort levels: pick the level in the model selector or with the new `/effort` command, cycle it with Ctrl-T, and see the current level in the footer and on the input box border.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Show estimated token throughput while output streams in the TUI footer, then replace it with the provider-reported completed rate.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add a TUI copy command for recent assistant responses and fenced code blocks with clipboard and file fallbacks.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Build the OpenTUI dialog slice with native searchable-dialog interactions.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Expose configuration and keybinding diagnostics through the TUI doctor command.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add `/colors` and polish terminal progress, context, question, and Markdown activity displays while preserving reasoning-summary boundaries.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add native TUI management for persisted allow, ask, and deny permission rules.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add TUI commands for listing discovered skills and configured hooks.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Complete the vim core for the composer: charwise and linewise visual mode with selection operators, and dot-repeat (`.`) driven by a structured repeat spec rather than replayed keystrokes.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add cancellable URL fetching with per-host approval and safe redirect handoff, plus allowed and blocked domain filters for web search.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Add a configurable `[status_line]` TUI section to toggle footer status items, and show the YOLO indicator on a dedicated row beneath the model.

### Patch Changes

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Align Anthropic-compatible thinking profiles, output limits, and incomplete stream handling with model capabilities.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Pulse the Bash activity marker while a command is running and keep the completed marker green.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Accept `/branch` and `/rewind` as compatibility aliases for `/fork` and `/undo`.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Allow provider catalog refresh for providers that register an API key directly instead of an environment variable.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Align context usage displays with 1024-based units and ceiled percentages.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Prevent repeated session debug exports from overwriting earlier archives by including a timestamp in the default filename.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Default agent reasoning and responses to English unless the user explicitly requests another language.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Increase the default per-step LLM retry budget from 3 to 10 attempts.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Allow DynamicWorkflow items to be complete prompts when no template is supplied.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Show DynamicWorkflow request failures once instead of repeating the reason for every member.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Pin @agentclientprotocol/sdk to ^0.23.0 to restore the unstable session-model API the ACP adapter implements, and fix the adapter's typecheck.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Rename the stale afk reference to auto in the built-in MCP configuration guidance.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Prevent agent idle cleanup failures from surfacing as unhandled rejections.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Translate binary download failures through the standard fetch error path.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Fix Unicode-safe Vim editing, application shortcuts, selector state, key chords, mouse-selection auto-scrolling, and active-tab contrast.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Preserve graceful shutdown and exit codes under repeated signals or closed output streams, persist provider removals and cleared defaults, reject unsafe marketplace refs, and recover safely from stalled marketplace loads and interrupted update installs.
...
- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Keep Dynamic Workflow results bounded and correctly decoded while preventing undone workflows from receiving late events.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Preserve MCP prompt client binding during skill activation.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Honor an explicit thinking off setting on OpenAI-compatible providers.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Correct the YOLO and Auto permission mode descriptions in CLI help output and ACP session mode selectors.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Correct the YOLO and Auto permission mode descriptions in the web slash command list and mobile permission sheet.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Clarify that YOLO auto-approves tool actions while Auto runs fully autonomously without asking questions.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Fix TypeScript errors in the TUI welcome/logo components and their tests (index-signature env access, possibly-undefined logo rows).

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Prevent silent exits from clipboard image failures and report unhandled promise rejections in crash telemetry.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Preserve extended Unicode characters when normalizing replacement quotes.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Fix sessions getting stuck after a provider records an assistant message with no sendable content.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Fix duplicate workspace groups on Windows when the same folder is opened with different path spellings, keeping all of the folder's sessions in one merged group.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Correct the YOLO mode notice shown when replaying a session.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Include the underlying network cause in OAuth connection error messages instead of only reporting a generic fetch failure.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Resolve every bare `solid-js` import to OpenTUI's client runtime so Solid signal updates reach the terminal buffer.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Stop showing a status message after successful automatic keybinding reloads.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Record and close tool calls that never ran after an interrupted model response.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Replay empty thinking content verbatim on preserved-thinking endpoints.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Scope inferred Anthropic thinking profiles to non-managed Anthropic-compatible providers.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Fix the built-in URL fetch tool's network safeguards so crafted domains and redirect chains cannot reach loopback or internal network services.

- [`6a834d3`](https://github.com/Pythoughts-labs/pythinker-code/commit/6a834d3d837834b5b4e07eb144be3138769e3b6a) - Render the slash command menu below the composer and give the selected command a themed pointer and muted description lines.
