...
- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add provider-native Fast mode controls for supported OpenAI and Anthropic models.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add validated session and persistent workspace directories with SDK, CLI, and TUI management.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose the precedence-resolved agent profile catalog through the SDK and a searchable TUI command.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add persistent named agent teams with background teammate spawning, shared task scopes, direct and broadcast messaging, assignment delivery, shutdown coordination, and native terminal identities.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add project, user, and namespaced plugin subagent profiles with per-profile turn limits and persistent memory, context-fork workers, per-agent model and working-directory overrides, and Git worktree isolation with native terminal status.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add Anthropic Claude Code marketplace browsing and installation with searchable source selection and install-definition support.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Preserve full truncated Bash output on disk, interpret informational exit codes, and expand destructive-command warnings in the terminal approval flow.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add clearer TUI startup status, effort heat, Dynamic Workflow progress colors, and a brighter dark-theme primary.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add catalog-backed provider connections with interactive or environment-referenced credentials, live model discovery, provider-aware model selection, and model-specific thinking controls.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add an agent-callable Config tool for approved, validated reads and writes of supported Pythinker settings.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add configurable Global and Chat TUI keybindings with unbinding, two-key chords, reserved shortcuts, dynamic help labels, template creation, and editor-backed reload.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose files loaded by Read through the SDK and a `/files` TUI command.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose the model-visible context breakdown through the SDK and a `/context` TUI report.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Show Dynamic Workflow in a coral-framed mission-control panel with live per-agent progress, and let workflow agents run without an automatic timeout.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add persisted file checkpoints with preview and recovery-backed code or conversation rewind through the SDK, CLI, and TUI.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add fail-closed Read/Edit/Write state tracking, quote-preserving edits, automatic parent creation, and cell-aware Jupyter notebook editing with terminal summaries.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add unchanged-range deduplication and structured Jupyter notebook reads with cell, text-output, and image-output support.
...
- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add configurable context-aware keybindings across dialogs, plugins, rewind,
  message actions, footer controls, and both terminal renderers.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add experimental plugin-configured language-server support with lazy stdio servers and agent-callable navigation, symbol, hover, reference, implementation, and call-hierarchy operations.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add MCP resource discovery and reading with terminal-native summaries.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add live instruction refresh and a `/memory` command for user and project memory files.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add discoverable built-in, user, project, and plugin output styles with config-backed prompt injection and TUI selection.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add experimental native PowerShell execution on Windows with non-interactive invocation, streamed foreground and background output, timeout handling, exact-command approval, and terminal language metadata.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add responsive option previews, per-question notes, answer annotations, automatic Other choices, and source telemetry tags to structured questions.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Complete Glob and Grep parity with absolute glob patterns, sensitive-name filtering, context aliases, and multiple glob filters.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add `/cost` to show accumulated session spend and current model token rates, with pricing data available through SDK session status.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose session metadata through the SDK and add searchable session tags with `/tag`.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add explicitly requested session worktree entry and exit with named resume, cwd and hook rebinding, safe keep behavior, and fail-closed removal confirmation.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add JSON Schema validated structured output to prompt mode.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add persistent project-task creation, lookup, dependency-aware listing, and updates while retaining explicit background-task listing.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add per-model thinking effort levels: pick the level in the model selector or with the new `/effort` command, cycle it with Ctrl-T, and see the current level in the footer and on the input box border.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Show estimated token throughput while output streams in the TUI footer, then replace it with the provider-reported completed rate.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add a TUI copy command for recent assistant responses and fenced code blocks with clipboard and file fallbacks.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Build the OpenTUI dialog slice with native searchable-dialog interactions.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose configuration and keybinding diagnostics through the TUI doctor command.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add `/colors` and polish terminal progress, context, question, and Markdown activity displays while preserving reasoning-summary boundaries.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add native TUI management for persisted allow, ask, and deny permission rules.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add TUI commands for listing discovered skills and configured hooks.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expand the TUI colour palette from 18 to 50 semantic tokens — shimmer variants, eight per-subagent identity colours, dimmed diff shades, a rainbow set, mode-identity badges, background surfaces, and progress-bar fill — and add a curried theme-aware `colorize` helper that accepts either a palette token or a raw hex.
...
- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add the `vim_mode` experimental flag, off by default, so modal editing in the composer can be toggled through `/vim` or `/experiments`, `PYTHINKER_CODE_EXPERIMENTAL_VIM_MODE`, or config. The editor picks the flag up when the snapshot lands and follows runtime configuration changes.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add the vim-mode state machine for the composer: NORMAL/INSERT transitions, counts, and the full movement set (character, line, word, line-anchored, document, and line-local find with repeat). Pure and renderer-agnostic — editing operators, text objects, and visual mode follow, as does the editor wiring.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add vim editing operators to the composer state machine: `d`/`c`/`y` over any motion, doubled linewise forms, the single-key shortcuts (`x`, `X`, `s`, `S`, `D`, `C`, `Y`), text objects (`iw`/`aw`, quotes, nested brackets), and an unnamed register with charwise and linewise paste.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Complete the vim core for the composer: charwise and linewise visual mode with selection operators, and dot-repeat (`.`) driven by a structured repeat spec rather than replayed keystrokes.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add a read-only verification agent and request independent checks when multi-step task lists close without verification.
...
- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add cancellable URL fetching with per-host approval and safe redirect handoff, plus allowed and blocked domain filters for web search.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Expose bounded working-tree diffs through the SDK and a native `/diff` browser.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Add a configurable `[status_line]` TUI section to toggle footer status items, and show the YOLO indicator on a dedicated row beneath the model.

### Patch Changes

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Align Anthropic-compatible thinking profiles, output limits, and incomplete stream handling with model capabilities.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Pulse the Bash activity marker while a command is running and keep the completed marker green.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Accept `/branch` and `/rewind` as compatibility aliases for `/fork` and `/undo`.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Allow provider catalog refresh for providers that register an API key directly instead of an environment variable.
...
- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Align context usage displays with 1024-based units and ceiled percentages.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Prevent repeated session debug exports from overwriting earlier archives by including a timestamp in the default filename.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Default agent reasoning and responses to English unless the user explicitly requests another language.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Increase the default per-step LLM retry budget from 3 to 10 attempts.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Allow DynamicWorkflow items to be complete prompts when no template is supplied.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Show DynamicWorkflow request failures once instead of repeating the reason for every member.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Pin @agentclientprotocol/sdk to ^0.23.0 to restore the unstable session-model API the ACP adapter implements, and fix the adapter's typecheck.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Rename the stale afk reference to auto in the built-in MCP configuration guidance.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Prevent agent idle cleanup failures from surfacing as unhandled rejections.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Translate binary download failures through the standard fetch error path.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix Unicode-safe Vim editing, application shortcuts, selector state, key chords, mouse-selection auto-scrolling, and active-tab contrast.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Preserve graceful shutdown and exit codes under repeated signals or closed output streams, persist provider removals and cleared defaults, reject unsafe marketplace refs, and recover safely from stalled marketplace loads and interrupted update installs.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix ctrl+b / ctrl+f paging in the approval preview and task output viewer under the Kitty keyboard protocol. Both shortcuts compared raw C0 bytes, so they did nothing in terminals that send CSI-u — including VSCode's integrated terminal — while the page-up/page-down checks beside them worked.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Keep Dynamic Workflow results bounded and correctly decoded while preventing undone workflows from receiving late events.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Preserve MCP prompt client binding during skill activation.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Honor an explicit thinking off setting on OpenAI-compatible providers.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Correct the YOLO and Auto permission mode descriptions in CLI help output and ACP session mode selectors.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Correct the YOLO and Auto permission mode descriptions in the web slash command list and mobile permission sheet.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Clarify that YOLO auto-approves tool actions while Auto runs fully autonomously without asking questions.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix TypeScript errors in the TUI welcome/logo components and their tests (index-signature env access, possibly-undefined logo rows).

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Prevent silent exits from clipboard image failures and report unhandled promise rejections in crash telemetry.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Preserve extended Unicode characters when normalizing replacement quotes.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix sessions getting stuck after a provider records an assistant message with no sendable content.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix duplicate workspace groups on Windows when the same folder is opened with different path spellings, keeping all of the folder's sessions in one merged group.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Correct the YOLO mode notice shown when replaying a session.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Include the underlying network cause in OAuth connection error messages instead of only reporting a generic fetch failure.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Resolve every bare `solid-js` import to OpenTUI's client runtime so Solid signal updates reach the terminal buffer.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Stop showing a status message after successful automatic keybinding reloads.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Record and close tool calls that never ran after an interrupted model response.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Replay empty thinking content verbatim on preserved-thinking endpoints.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Scope inferred Anthropic thinking profiles to non-managed Anthropic-compatible providers.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Fix the built-in URL fetch tool's network safeguards so crafted domains and redirect chains cannot reach loopback or internal network services.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Render the slash command menu below the composer and give the selected command a themed pointer and muted description lines.

- [`d5890f9`](https://github.com/Pythoughts-labs/pythinker-code/commit/d5890f964e1935de73d5c1f94b7d0b301c771b01) - Make MCP startup status lines transient in the TUI: connected/disabled rows show a success mark and disappear after 3 seconds instead of permanently cluttering the transcript, while failed and needs-auth rows stay visible. The welcome-header aggregate remains the durable indicator.
