...
describe('MouseController', () => {
  ...
  it('clears the selection when clicking the chrome area below the transcript', () => {
    ...
    fire('\u001B[<0;10;8M'); // below the 4-row transcript region
