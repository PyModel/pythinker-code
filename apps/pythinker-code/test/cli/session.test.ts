...
import type { ListSessionsOptions, SessionSummary } from '@pymodel/pythinker-code-sdk';

function summary(overrides: Partial<SessionSummary> = {}): SessionSummary {
  return {
    id: 'ses_1',
    workDir: '/repo',
    sessionDir: '/home/.pythinker-code/sessions/wd_repo/ses_1',
    createdAt: 1,
...
describe('registerSessionCommand', () => {
  it('parses session list options and runs the handler', async () => {
    ...
    await program.parseAsync(['node', 'pythinker', 'session', 'list', '--all', '--json']);
