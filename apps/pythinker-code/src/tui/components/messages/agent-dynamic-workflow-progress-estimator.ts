...
export type AgentDynamicWorkflowProgressEstimatorPhase =
  | 'pending'
  | 'queued'
  | 'suspended'
  | 'running'
...
export interface AgentDynamicWorkflowProgressEstimatorOptions {
...
export interface AgentDynamicWorkflowProgressEstimateInput {
  readonly memberKey: string;
  readonly phase: AgentDynamicWorkflowProgressEstimatorPhase;
  readonly capacityTicks: number;
  readonly nowMs: number;
}

export interface AgentDynamicWorkflowProgressEstimate {
...
export class AgentDynamicWorkflowProgressEstimator {
  ...
  constructor(options: AgentDynamicWorkflowProgressEstimatorOptions = {}) {
  ...
  estimate(input: AgentDynamicWorkflowProgressEstimateInput): AgentDynamicWorkflowProgressEstimate {
    const state = this.getOrCreateMember(input.memberKey);
  ...
  estimateAll(
    inputs: readonly AgentDynamicWorkflowProgressEstimateInput[],
  ): Map<string, AgentDynamicWorkflowProgressEstimate> {
    const estimates = new Map<string, AgentDynamicWorkflowProgressEstimate>();
