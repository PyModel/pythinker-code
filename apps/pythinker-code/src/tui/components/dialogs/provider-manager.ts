 ...
 * Pythinker Code OAuth (`DEFAULT_OAUTH_PROVIDER_NAME`) is intentionally hidden
 ...
 * through callbacks. The host (`PythinkerTui`) is responsible for performing
...
export class ProviderManagerComponent extends Container implements Focusable {
  ...
  override render(width: number): string[] {
    ...
    lines.push(currentTheme.fg('textMuted', ' ' + this.headerHint()));
    lines.push('');
