...
import type { PythinkerMarkdownTheme } from '#/tui/theme/pi-tui-theme';
import { getMarkdownMermaidMode, type MermaidRenderMode } from '#/tui/utils/markdown-options';

import { MermaidBlock } from './mermaid-block';

export interface PythinkerMarkdownOptions extends MarkdownOptions {
  copySource?: boolean;
...
export class Markdown extends Container {
  ...
  private readonly options: PythinkerMarkdownOptions;
  ...
  constructor(
    ...
    options?: PythinkerMarkdownOptions,
  ) {
    super();
