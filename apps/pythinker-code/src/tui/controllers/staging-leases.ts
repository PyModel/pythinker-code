 ...
 *
 * Self-contained state machine extracted from `PythinkerTUI`: the two side effects
...
import type { TurnEndedEvent, TurnStartedEvent } from '@pymodel/pythinker-code-sdk';
