 ...
 * (`createPythinkerHarness`, the default) or the experimental agent-core-v2 engine
 * (`createPromptHarnessV2`, gated by `PYTHINKER_CODE_EXPERIMENTAL_FLAG`). Both the
 * v1 `PythinkerHarness` / `Session` and the v2 harness structurally satisfy these
