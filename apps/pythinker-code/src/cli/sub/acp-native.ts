/**
 * Native `pythinker acp` implementation.
 *
 ...
 * clients can drive a pythinker-code session on the default engine.
 *
...
export function registerNativeAcpCommand(parent: Command): void {
  parent
    ...
    .option(
      '--region <region>',
      'Login region used together with --login: "mainland-cn" (pythinker.com) or "global" (pythinker.ai).',
    )
