/**
 * Shared helpers for `pythinker web` and its subcommands.
 *
...
import type { ServerLogLevel } from '@pymodel/agent-gateway';
...
/** Filename (under PYTHINKER_CODE_HOME) of the persistent server bearer token. */
 ...
 * is the CLI's own PYTHINKER_CODE_HOME resolution (`getDataDir()`).
 *
