...
export function createHostSupervisor(options: HostSupervisorOptions): HostSupervisor {
  ...
  const start = (): Promise<string> => {
    ...
    startPromise = new Promise<string>((resolve, reject) => {
      ...
      startupCleanups.push(spawned.stdout.onData(acceptChunk), spawned.stderr.onData(appendOutput))
 ...
 */
export function spawnPythinkerServer(options: SpawnPythinkerServerOptions): HostChild {
