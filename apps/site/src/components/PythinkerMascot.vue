...
defineProps({
  ...
  ariaLabel: { type: String, default: 'Pythinker mascot' },
});
</script>
  ...
  >
    <g>
      ...
      <g>
        ...
        <g>
          <path fill="#213853" fill-rule="nonzero" d="M191.366 111.116a9.653 9.653 0 016.842 2.835 9.649 9.649 0 012.835 6.843 9.652 9.652 0 01-2.835 6.843 9.648 9.648 0 01-6.842 2.835 9.65 9.65 0 01-6.844-2.835 9.657 9.657 0 01-2.835-6.843 9.653 9.653 0 012.835-6.843 9.657 9.657 0 016.844-2.835z" />
        ...
        <g class="pym-eye-group">
          ...
          <g class="pym-eye-iris">
            ...
            <path fill="#FFFFFF" d="M131.395 180.117c5.614 0 10.164 4.55 10.164 10.163 0 5.615-4.55 10.164-10.164 10.164s-10.164-4.549-10.164-10.164c0-5.613 4.55-10.163 10.164-10.163z" />
          </g>
        </g>
        <g class="pym-eye-group pym-eye-right">
          ...
          <g class="pym-eye-iris pym-eye-iris-right">
            ...
            <path fill="#FFFFFF" d="M275.757 180.117c5.614 0 10.163 4.55 10.163 10.163 0 5.615-4.549 10.164-10.163 10.164s-10.164-4.549-10.164-10.164c0-5.613 4.55-10.163 10.164-10.163z" />
          </g>
        </g>
        <g class="pym-mouth">
          <path fill="#213853" fill-rule="nonzero" d="M237.741 265.105a6.252 6.252 0 110 12.503h-63.197a6.252 6.252 0 110-12.503h63.197z" />
        </g>
      </g>
...
<style scoped>
/* Animation classes scoped to this component. The original SVG file
   keeps its inline <style> for use as a standalone <img> (favicons etc.);
   here we move it to the .vue style block because Vue's compiler refuses
   side-effect tags (<style>, <script>) inside templates. */
@keyframes pyMascotBlink {
  0%, 83%, 85%, 87%, 89%, 100% { transform: scaleY(1); }
  84% { transform: scaleY(0.05); }
  88% { transform: scaleY(0.05); }
}
@keyframes pyMascotMouthTalk {
...
@keyframes pyMascotAntennaGlow {
  0%, 100% { filter: drop-shadow(0 0 0 #EE9983); }
  50% { filter: drop-shadow(0 0 6px #EE9983) drop-shadow(0 0 12px #DD786D); }
}
@keyframes pyMascotEyeShine {
  0%, 80%, 100% { filter: none; }
  90% { filter: drop-shadow(0 0 3px #AFE3F1); }
}

.pym-eye-group { animation: pyMascotBlink 12s ease-in-out infinite; transform-origin: center center; }
.pym-eye-right { animation-delay: 0.06s; }
.pym-mouth { animation: pyMascotMouthTalk 15s ease-in-out infinite; transform-origin: 206px 271px; }
.pym-antenna { animation: pyMascotAntennaGlow 3s ease-in-out infinite; }
.pym-eye-iris { animation: pyMascotEyeShine 12s ease-in-out infinite; }
.pym-eye-iris-right { animation-delay: 0.2s; }
