...
// `pnpm --filter @pythoughts/dashboard-web typecheck` here until a renderer is
// added. This is the anti-rot guarantee that keeps dashboard from silently falling
...
export const WIRE_RENDERERS: RendererMap = {
  ...
  'dynamic_workflow_mode.exit': {
    tone: 'subagent',
    label: 'workflow✓',
    headline: () => ({ main: <Dim>dynamic workflow exited</Dim> }),
  },
...
/** Look up a renderer by runtime type.
 *
