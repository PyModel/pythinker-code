...
export interface ConnectOptions {
  ...
  /** Remember just this URL as the preferred discovery pick (`pythinker-inspect.server-url`). */
  readonly rememberServerUrl?: string;
}

const STORAGE_KEY = 'pythinker-inspect.connection';
const REMEMBERED_SERVER_KEY = 'pythinker-inspect.server-url';
    ...
    <div className="flex h-screen items-center justify-center">
      ...
      >
        ...
        <p className="mb-5 text-xs text-neutral-500">
          ...
          {` (${__PYTHINKER_INSPECT_PROXY_TARGET__})`}.
        </p>
        {servers.length > 0 ? (
          <div className="mb-5">
        ...
        <input
          ...
          placeholder="~/.pythinker-code/server.token"
          value={token}
...
declare const __PYTHINKER_INSPECT_PROXY_TARGET__: string;
