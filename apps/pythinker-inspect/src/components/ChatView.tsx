 ...
 * (`@pymodel/agent-gateway/protocol`). Prompts/cancels go through the
...
import type {
  ...
  TurnMessage,
  UserMessage,
} from '@pymodel/agent-gateway/protocol';
import {
  createContext,
  useCallback,
  useContext,
...
function SessionStateBadges({ sessionState }: { sessionState: SessionStateMessage }) {
  return (
    <>
      ...
      {sessionState.modes?.dynamic_workflow !== undefined ? <Badge tone="violet">dynamic_workflow</Badge> : null}
