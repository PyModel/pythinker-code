...
describe('mergeSnapshotSubagents', () => {
  ...
  it('seeds an empty store from the roster', () => {
    const roster = [
      subagent('a1', { subagentPhase: 'working', dynamicWorkflowIndex: 0, parentToolCallId: 'call-1' }),
      subagent('a2', { subagentPhase: 'queued', dynamicWorkflowIndex: 1, parentToolCallId: 'call-1' }),
    ];
...
describe('keepLiveSubagents', () => {
  ...
  it('keeps WS-only dynamic_workflow subagents that REST omits', () => {
    const rest: AppTask[] = [];
