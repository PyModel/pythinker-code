...
<!-- pythinker-web is working in, with a clickable breadcrumb and the folder list -->
...
const props = defineProps<{
  ...
  /** Where the browser opens by default — the path pythinker-web is working in. */
  defaultPath?: string;
...
onMounted(async () => {
  ...
  try {
    ...
    // Default to the path pythinker-web is working in; fall back to $HOME.
