...
const DRAFT_PREFIX = 'pythinker-web.draft.';
...
function handleSubmit(): void {
  ...
  // `/workflow <task>`, `/btw <question>`, slash skills with args, and bare
...
// Modes selector (plan / goal / Dynamic Workflow) — the popover that replaces the bare
// "plan" pill. Plan and Dynamic Workflow are real client toggles; goal reflects agent-driven
    ...
    <div class="composer-card">
      ...
      <div ref="toolbarRef" class="toolbar">
        ...
        <div class="toolbar-left">
          ...
          <!-- Modes selector (plan / goal / Dynamic Workflow) — replaces the plan pill. -->
          <div v-if="status" ref="modesRef" class="modes">
            ...
            <div v-if="modesOpen" ref="modesMenuRef" class="modes-menu" :style="modesMenuStyle">
              ...
              <button type="button" class="mode-row" :class="{ on: dynamicWorkflowOn }" @click="emit('toggleDynamicWorkflow')">
...
/* Modes selector (plan / goal / Dynamic Workflow) — replaces the old plan pill + badges.
