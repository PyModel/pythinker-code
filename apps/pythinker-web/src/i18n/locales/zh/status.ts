export default {
  ...
  // 模式选择器（计划 / 目标 / DynamicWorkflow）
  modesLabel: '模式',
  goalLabel: '目标',
  goalDesc: '持续跟踪一个目标，直到任务完成',
  dynamic_workflowLabel: 'DynamicWorkflow',
  dynamic_workflowDesc: '并行运行多个智能体，适合大范围探索',
  modeOff: '未启用',
  ...
  statusPermission: '权限',
  statusPlanMode: '计划模式',
  statusDynamicWorkflowMode: 'DynamicWorkflow 模式',
  dynamic_workflowOn: '开',
  dynamic_workflowOff: '关',
  statusContext: '上下文',
  statusCost: '花费',
