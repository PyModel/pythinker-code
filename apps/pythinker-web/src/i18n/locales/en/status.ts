export default {
  ...
  // Mode selector (Plan / Goal / Dynamic Workflow)
  modesLabel: 'Mode',
  modesTooltip: 'Mode: Plan / Goal / Dynamic Workflow',
  goalLabel: 'Goal',
  dynamicWorkflowLabel: 'Dynamic Workflow',
  modeOff: 'Off',
  ...
  statusDynamicWorkflowMode: 'Dynamic Workflow mode',
