export default {
  ...
  desktop: {
    ...
    updateChannelHint: 'Stable receives production releases. Beta and Nightly receive prereleases when desktop feeds are published.',
    channels: {
      stable: 'Stable',
      beta: 'Beta',
      nightly: 'Nightly',
    ...
    automaticChecksHint: 'Check automatically. Downloads and restarts always need your approval.',
    status: 'Status',
