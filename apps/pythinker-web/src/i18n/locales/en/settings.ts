export default {
  ...
  subagentRouting: {
    ...
    modeHint: {
      inherit: 'Subagents use the main model',
      default: 'Subagents use this model unless the agent chooses another',
      pool: 'The agent picks from these models; one is the default',
      force: 'Every subagent uses this model',
    },
    model: 'Model',
    modelHint: 'Model and thinking effort for new subagents',
    pool: 'Pool',
    poolHint: 'Select the models the agent may choose',
    poolDefault: 'Default',
    makeDefault: 'Make default',
    saved: 'Saved policy',
    effective: 'Effective routing',
    featureDisabled: 'Secondary-model feature is disabled; subagents inherit the main model',
    summaryInherit: 'Inherit agent model',
    summaryPool: '{count} models · default {model}',
  },
  expertOpinion: {
    title: 'Expert Talk',
    enabled: 'Enable Expert Talk',
    enabledHint: 'Show the two-expert Fusion workflow in the composer.',
    unavailable: 'Expert Talk requires the v2 engine and an active session.',
    ...
    savePair: 'Save model pair',
    saved: 'Saved for the active session',
  },
