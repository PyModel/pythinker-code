export default {
  ...
  deleteSessionConfirm: 'Delete “{title}”? This permanently deletes the session and its history. You cannot undo this action.',
  deleteSessionToast: 'This session was deleted',
