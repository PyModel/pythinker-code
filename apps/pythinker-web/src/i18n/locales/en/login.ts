export default {
  ...
  errorHint: 'Please upgrade pythinker-code and try again',
  pollErrorTitle: 'Lost connection to the daemon',
  pollErrorHint: 'Authorization polling failed repeatedly. Check the pythinker-code process and try again.',
} as const;
