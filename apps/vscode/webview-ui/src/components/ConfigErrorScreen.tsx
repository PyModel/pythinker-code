    ...
    <>
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Sign in with a Pythinker account, or configure a provider and model in your shared Pythinker Code <code className="bg-muted px-1 rounded">config.toml</code>.
        </p>
      </div>
      ...
      <div className="bg-muted/50 rounded-lg p-4 text-left space-y-2">
        <div className="flex items-center gap-2 text-xs font-medium">
          ...
          Shared Pythinker Code configuration
        </div>
        <p className="text-xs text-muted-foreground">
          VS Code and the terminal UI use the same Pythinker Code home, configuration, credentials, and sessions.
        </p>
      </div>
      ...
      <div className="h-full flex items-center justify-center p-6">
        <div className="text-center space-y-4">
          ...
          <div className="inline-flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-sm">Starting Pythinker Code...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="h-full flex items-center justify-center p-6">
        <div className="max-w-sm text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Open a folder to start using Pythinker Code.</p>
          </div>
          <Button
            onClick={() => {
    ...
    <div className="flex-1 min-h-0 overflow-y-auto p-6">
      <div className="max-w-sm mx-auto text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Check the error below. Full diagnostics are available in the Pythinker Code output channel.</p>
        </div>
