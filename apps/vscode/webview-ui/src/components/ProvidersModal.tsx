...
export function ProvidersModal() {
  const { providersModalOpen, setProvidersModalOpen } = useSettingsStore();
  ...
  if (!providersModalOpen) return null;
      ...
      <div className="fixed inset-0 z-40 flex flex-col bg-background">
        <div className="flex items-center justify-between px-3 py-2 border-b">
          <div className="flex items-center gap-2">
            <IconPlug className="size-4 text-brand" />
          ...
          <div className="flex items-center gap-1">
            ...
            <Button variant="ghost" size="icon" className="size-6" onClick={() => setProvidersModalOpen(false)}>
