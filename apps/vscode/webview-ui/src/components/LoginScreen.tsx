    ...
    return (
      <div className="h-full flex items-center justify-center p-6">
        <div className="max-w-sm w-full text-center space-y-6">
          <PythinkerMascot className="h-12 mx-auto" />
        ...
        <div className="max-w-sm w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-left space-y-2">
              <p className="text-xs leading-5">Use Pythinker Code with your Pythinker account subscription or your existing API setup.</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            <div className="text-left space-y-1">
              ...
              >
                Sign in with Pythinker Account
              </Button>
              <p className="text-[11px] text-muted-foreground leading-4">Use your Pythinker account and Pythinker Code subscription.</p>
            </div>
      ...
      <AlertDialog open={showSubscribeDialog} onOpenChange={setShowSubscribeDialog}>
        <AlertDialogContent size="sm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Your account does not have an active Pythinker Code subscription. Please subscribe to continue using Pythinker Code with your account.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
