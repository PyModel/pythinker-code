...
import { IconPlus, IconChevronDown, IconInfoCircle, IconSettings } from "@tabler/icons-react";
  ...
  return (
    <header className="flex items-center justify-between px-3 py-2 border-b border-border shrink-0 @container">
      <div className="flex items-center gap-2 shrink-0">
        ...
        <span className="text-sm font-semibold whitespace-nowrap">Pythinker Code</span>
      </div>
