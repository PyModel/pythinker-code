...
export const Methods = {
  ...
  GetPythinkerSessions: "getPythinkerSessions",
  GetAllPythinkerSessions: "getAllPythinkerSessions",
  GetRegisteredWorkDirs: "getRegisteredWorkDirs",
  SetWorkDir: "setWorkDir",
  BrowseWorkDir: "browseWorkDir",
  LoadPythinkerSessionHistory: "loadPythinkerSessionHistory",
  DeletePythinkerSession: "deletePythinkerSession",
  ForkPythinkerSession: "forkPythinkerSession",
...
function validateParams(method: RpcMethod, params: unknown): boolean {
  switch (method) {
    ...
    case Methods.GetPythinkerSessions:
    case Methods.GetAllPythinkerSessions:
    ...
    case Methods.LoadPythinkerSessionHistory:
      return hasNonEmptyString(params, "pythinkerSessionId");
    case Methods.DeletePythinkerSession:
      return hasNonEmptyString(params, "sessionId");
    case Methods.ForkPythinkerSession:
      return isPlainObject(params)
