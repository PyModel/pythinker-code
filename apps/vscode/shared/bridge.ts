...
function validateParams(method: RpcMethod, params: unknown): boolean {
  switch (method) {
    ...
    case Methods.GetSessions:
    case Methods.GetAllSessions:
    ...
    case Methods.SaveExtensionConfig:
      return isPlainObject(params)
        && isOptionalType(params["yoloMode"], "boolean")
        && isOptionalType(params["autosave"], "boolean")
        && isOptionalType(params["useCtrlEnterToSend"], "boolean")
    ...
    case Methods.LoadSessionHistory:
      return hasNonEmptyString(params, "sessionId");
    case Methods.DeleteSession:
      return hasNonEmptyString(params, "sessionId");
