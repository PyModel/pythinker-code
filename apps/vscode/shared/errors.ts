...
export const ERROR_MESSAGES: Record<string, string> = {
  // Pre-flight
  [LEGACY.CLI_NOT_FOUND]: "Pythinker Code CLI not found.",
  [LEGACY.SPAWN_FAILED]: "Failed to start Pythinker Code CLI.",
  [LEGACY.ALREADY_STARTED]: "A session is already running.",
  [LEGACY.STDIN_NOT_WRITABLE]: "Failed to communicate with Pythinker Code CLI.",
  ...
  "config.invalid": "Pythinker Code configuration is invalid.",
