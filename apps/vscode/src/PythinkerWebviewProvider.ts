...
import type { PermissionMode, PythinkerHarness } from "@pymodel/pythinker-code-sdk";
...
export class PythinkerWebviewProvider implements vscode.WebviewViewProvider {
  ...
  createPanel(): vscode.WebviewPanel {
    ...
    const panel = vscode.window.createWebviewPanel("pythinkerPanel", "Pythinker Code", vscode.ViewColumn.One, {
      enableScripts: true,
